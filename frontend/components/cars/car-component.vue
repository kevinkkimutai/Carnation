      ...
      <a href="/">
        ...
        <div class="mt-3 w-full flex text-gray-900 dark:text-white">
          ...
          <h2 class="text-md md:text-md text-start w-1/4">
            <span
              class="inline-flex select-none rounded-full bg-green-900 px-2 py-1 text-xs font-semibold text-white"
            >
              In Stock
            </span>
          </h2>
        ...
        <div class="justify-center flex-row">
          ...
          >
            <P>
              Subaru,XV, fabric seats , bright interior, alloy reems,leather
              seats
            </P>
          </div>
        </div>
