<template>
  <section
    class="bg-white dark:bg-gray-800 shadow-2xl mt- sm:mt-1 pt-5 p-2 rounded-lg"
  >
    <h1 class="text-3xl text-white sm:text-2xl ms-1 font-bold">Send Inquiry</h1>
...
export default Vue.extend({
  ...
  methods: {
    ...mapActions("inventory", ["sendEnquiry"]),
    async submitForm() {
      try {
        ...
        const response = await this.sendEnquiry({
          id: this.car.id,
