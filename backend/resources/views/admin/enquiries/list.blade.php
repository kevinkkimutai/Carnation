                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Car enquiries</h4>
                                ...
                                <div class="flex">
                                    ...
                                    <div>
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Car enquiries</a>
                                        ...
                                        <tbody>
                                            @foreach ($messages as $index => $message)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('inventory.show', $message->carDetails->slug) }}">
                                                            {{ $message->carDetails->title }}</a>
                                                    </td>
