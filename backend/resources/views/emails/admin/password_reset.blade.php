                    ...
                    <tbody>
                        <tr>
                            <td><b>Dear {{ $user->first_name }},</b>
                                <p>You recently requested to reset your password for your Carbation Auto Mart Account.
                                    Click on the
                                    button below to reset it.</p>
                                <a href="{{ route('admin.password.new', $user->remember_token) }}"
                                ...
                                <p>If you did not request a password reset, please ignore this email or reply to let us
                                    know. This password reset is only valid for the next 7 Days.
                                </p>
                                <b>Thanks,<br>
                                    <b> {{ env('APP_NAME') }} </b>
                                </b>
